...
<#
	...
	.EXAMPLE
		Initialize-SPOSite -SiteUrl "https://tenant.sharepoint.com/teams/MyTeam"
	...
	.NOTES
		...
		AUTHOR: Giuseppe Campanelli, suprememilanfan@gmail.com
#>
	param([Parameter(Mandatory)][string]$SiteUrl = $(throw "Please specify the URL of the SPO site collection."))
